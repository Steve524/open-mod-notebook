...
/** Shared types for the Open Notebook Obsidian plugin. Leaf module — no src/ imports. */

export interface NotebookSyncSettings {
	serverUrl: string;
	apiToken: string;
	// Open Notebook ids are string record ids (e.g. "notebook:abc"), not the
	// numeric ids SurfSense used. Field names kept for minimal churn.
...
export const DEFAULT_SETTINGS: NotebookSyncSettings = {
