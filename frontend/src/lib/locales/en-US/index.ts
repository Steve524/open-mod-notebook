export const enUS = {
  ...
  settings: {
    ...
    obsidianSyncDesc: "Sync an Obsidian vault into Open Notebook with the companion plugin.",
    obsidianSyncBody: "The plugin runs inside Obsidian and pushes your notes to this server — no shared folder needed, and it works on mobile. Use this server's URL and your app password as the token, then pick a notebook to sync into.",
    obsidianSyncGuide: "Open the plugin install guide →",
  },
  advanced: {
    title: "AdvancedTools",
  ...
  vault: {
    refresh: "Refresh vaults",
    addVault: "Connect a vault",
    addVaultDesc: "Sync a local folder (e.g. an Obsidian vault) as sources — all supported document types (Markdown, PDF, Word, text, code, and more), not just Markdown. The server reads the folder, so use the path as the server sees it.",
    supportedHint: "Synced: Markdown, PDF, Word/Excel/PowerPoint, plain text, code, and structured data (XML, YAML). HTML, JSON, CSV, EPUB, images, audio, and video are skipped.",
    linkNew: "Link new",
    subscribeExisting: "Subscribe to existing",
    subscribeTitle: "Subscribe to a vault",
    subscribeOnlyDesc: "Subscribe this notebook to a vault pushed by the Obsidian plugin. To add a vault, install the Open Notebook plugin in Obsidian (see its README).",
    nameLabel: "Name",
    namePlaceholder: "My Vault",
    pathLabel: "Folder path",
    pathHelp: "Use Browse to pick a folder, or paste a path like C:\\Users\\you\\Documents\\MyVault. It must be inside the folder shared with the app (VAULTS_HOST_DIR).",
    validate: "Validate",
    browse: "Browse folders",
    browseTitle: "Browse server folders",
    browseDesc: "Navigate the folder shared with the app (VAULTS_HOST_DIR) and pick the vault. Only folders under it are visible.",
    browseUp: "Up one level",
    browseEmpty: "No sub-folders here.",
    browseError: "Couldn't read this folder.",
    browseUseFolder: "Use this folder",
    browseDocCount: "{count} docs",
    validateOk: "Looks good — {count} supported file(s) found.",
    validateNotAllowed: "This path is outside the allowed vaults directory.",
    ...
    noConnections: "No vaults connected yet. Use \"Link new\" to add one.",
    subscribers: "{count} subscriber(s)",
    fileCount: "{count} file(s)",
    connectedVaults: "Connected vaults",
    pushVault: "Obsidian vault (push)",
    live: "Live",
    manual: "Manual",
    ...
    unsubscribeConfirm: "Remove this vault from this notebook? Other notebooks and the vault itself stay.",
    refreshStarted: "Refreshing vaults…",
    refreshStartedDesc: "Submitted {count} sync job(s). Sources will update shortly.",
    refreshFailed: "Failed to refresh vaults",
    linked: "Vault linked",
    linkedDesc: "The first sync has started. Sources will appear shortly.",
    linkFailed: "Failed to link vault",
    subscribed: "Subscribed",
    subscribedDesc: "This notebook now receives the vault's sources.",
    subscribeFailed: "Failed to subscribe",
    unsubscribed: "Unsubscribed",
    unsubscribedDesc: "This vault was removed from the notebook.",
    unsubscribeFailed: "Failed to unsubscribe",
    refreshAll: "Refresh vaults",
    inherit: "Inherit",
    statusIdle: "Idle",
    ...
    colPath: "Path",
    colMode: "Mode",
    colSubscribers: "Notebooks",
    colFiles: "Files",
    colLastSynced: "Last synced",
    colStatus: "Status",
    editVault: "Edit vault",
    editVaultDesc: "Update the folder, filters, and sync mode for this vault. Changes apply on the next refresh.",
    editPathHelp: "Changing the path re-scans the vault on the next refresh.",
    modeLabel: "Sync mode",
    modeInherit: "Inherit (use the global Settings default)",
    modeManual: "Manual (refresh on request)",
    modeLive: "Live (auto-sync on change)",
    modeHelp: "\"Inherit\" follows the global Vault sync setting. Override it here for just this vault.",
    removeLink: "Remove link",
    removeLinkConfirm: "Remove the vault \"{name}\"? This deletes the connection and stops syncing for all {count} notebook(s) that use it.",
    removeLinkBlastRadius: "This connection is used by {count} notebook(s). Removing it stops syncing for all of them. Your files on disk are never deleted.",
    deleteSources: "Also delete the {count} synced source(s) from Open Notebook",
    deleteSourcesHelp: "Removes the imported sources from notebooks. Your original files on disk are kept.",
    updated: "Vault updated",
    updateFailed: "Failed to update vault",
    removed: "Vault removed",
    removedDesc: "Connection removed. {count} source(s) deleted.",
