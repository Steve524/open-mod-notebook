export const enUS = {
  ...
  vault: {
    ...
    pathHelp: "The path as the server sees it. In Docker, bind-mount the vault and enter the in-container path (e.g. /vaults/MyVault).",
    validate: "Validate",
    browse: "Browse folders",
    browseTitle: "Browse server folders",
    browseDesc: "Pick a folder the server can read. In Docker this is the in-container path (e.g. a bind-mounted vault).",
