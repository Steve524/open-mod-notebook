export const enUS = {
  ...
  vault: {
    ...
    addVaultDesc: "Sync a local folder (e.g. an Obsidian vault) as sources. The server reads the folder, so use the path as the server sees it.",
    linkNew: "Link new",
    ...
    browseMdCount: "{count} md",
    validateOk: "Looks good — {count} markdown file(s) found.",
